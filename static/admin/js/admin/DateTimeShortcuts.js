...
//     <input onfocus="clearInputValue(this)" onblur="restoreInputValue(this)" placeholder="0.00" inputmode="numeric" type="text" class="vDateField">
//     <input onfocus="clearInputValue(this)" onblur="restoreInputValue(this)" placeholder="0.00" inputmode="numeric" type="text" class="vTimeField">
"use strict";
{
  const DateTimeShortcuts = {
    ...
    addClock: function (inp) {
      ...
      // where name is the name attribute of the <input onfocus="clearInputValue(this)" onblur="restoreInputValue(this)" placeholder="0.00" inputmode="numeric">.
      const name =
